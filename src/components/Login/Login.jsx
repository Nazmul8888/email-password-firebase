    ...
    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
      <div className="card-body">
        ...
        <div className="form-control">
          ...
          />
          <label className="label">
            <a onSubmit={handelResetLogin} href="#" className="label-text-alt link link-hover">Forgot password?</a>
          </label>
        </div>
        ...
        </form>
        {
            ...
            <p className="label-text-alt link link-hover"> new to this website? Please <Link to='/register'>Register</Link> </p>
      </div>
    </div>
  </div>
</div>
